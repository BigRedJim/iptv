...
O0oOO0o0 = 'http://team.stvhosting.com:25461/get.php?username=' + IIi1IiiiI1Ii + '&password=' + I11i11Ii + '&type=m3u_plus&output=ts'
i1ii1iIII = 'http://team.stvhosting.com:25461/xmltv.php?username=' + IIi1IiiiI1Ii + '&password=' + I11i11Ii + '&type=m3u_plus&output=ts'
...
def O00OooO0 ( name , url , icon , schedule = False ) :
 ...
 name = name . split ( ' -' ) [ 0 ]
 o00o = [ ]
 OOOo0 . create ( 'The Farm' , 'Fetching EPG Data' )
 II111iiii = O0 ( )
